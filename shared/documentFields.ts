...
export const CATEGORY_FIELDS: Record<string, DocField[]> = {
  ...
  company: [
    { key: "subcategoria", label: "Subcategoria", options: ["Cartão CNPJ", "Contrato Social", "Alteração Contratual", "Procuração", "Alvará/Licença", "Certificado digital", "Balanço/DRE", "Extrato bancário", "Outro"] },
    { key: "cnpj", label: "CNPJ" },
    { key: "razaoSocial", label: "Razão social" },
    { key: "nomeFantasia", label: "Nome fantasia" },
    { key: "dataAbertura", label: "Data de abertura", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "situacao", label: "Situação cadastral", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "naturezaJuridica", label: "Natureza jurídica", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "cnae", label: "CNAE principal", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "porte", label: "Porte", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "endereco", label: "Endereço", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    { key: "inscricaoEstadual", label: "Inscrição estadual", showWhen: [{ field: "subcategoria", valueNot: "Extrato bancário" }] },
    // Extrato bancário
    { key: "instituicaoBancaria", label: "Instituição bancária", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "banco", label: "Banco", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "agencia", label: "Agência", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "conta", label: "Conta", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "dataPdfGerado", label: "PDF gerado em", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "dataPeriodoInicio", label: "Período do extrato — início", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
    { key: "dataPeriodoFim", label: "Período do extrato — fim", showWhen: [{ field: "subcategoria", value: "Extrato bancário" }] },
  ],
  tax: [
